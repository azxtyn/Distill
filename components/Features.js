  ...
  return (
    <section id="features" className="px-6 py-20 bg-gray-50">
      <div className="text-center mb-12">
        <p className="text-xs font-medium tracking-widest text-emerald-600 uppercase mb-2">Features</p>
        <h2 className="text-3xl font-medium text-gray-900">Everything you need to learn smarter</h2>
      </div>
